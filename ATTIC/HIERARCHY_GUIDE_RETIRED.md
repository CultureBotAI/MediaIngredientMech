...
> **RETIRED 2026-08-25 (#448).** This document describes an unpopulated prototype
> whose record keys, helpers, and examples do not match the maintained schema.
> It is historical design material, not supported curation guidance. See
> `docs/HIERARCHY_GUIDE.md` for the current boundary.
