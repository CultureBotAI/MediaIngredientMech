...
description: 'Semantic identifier for the record and its LinkML identifier slot, but
  ...
  the identifier itself names the grounded ontology term, but registry or local identities
  may legitimately differ from the ontology target at any evidence-backed mapping
  quality.'
