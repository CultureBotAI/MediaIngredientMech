...
- Current SSSOM UNKNOWN_TERM rows: 691
...
| kg-microbe placeholder rows needing promotion review | 54 | No exact OLS candidate remains after this pass; keep as manual placeholder queue. |
...
- Current placeholder rows remaining in manual queue: 54
- Current queue artifact: `mappings/ingredient_mappings_unknown_term_placeholder_ols_candidates.tsv`.

## Outcome

- Ingredient YAML changed for eight placeholder promotions and two duplicate retirements.
