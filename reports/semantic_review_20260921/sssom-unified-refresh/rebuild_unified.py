"""Reproduce the SSSOM-finalization unified export using a reviewed claw producer.
...
def main():
    ...
    evidence = dict(
        ...
        rows=len(rows),
        scope="MIM SSSOM-finalization refresh; current local CultureMech recipes read only; not proof that downstream media were regenerated",
    )
