...
SOURCE_LABEL_IDENTIFIER_OVERRIDES = {
    ...
    _source_label_key("Algal Trace Elements Solution"): "kgmicrobe.ingredient:algal_trace_elements_solution",
    _source_label_key("Casamino acids, vitamin assay (BD-Difco)"): "kgmicrobe.ingredient:casamino_acids_vitamin_assay",
    _source_label_key("Casamino acids, vitamin assay (Difco)"): "kgmicrobe.ingredient:casamino_acids_vitamin_assay",
